            ...
            <div class="container">
                ...
                <div class="table-responsive cart_info">
                    <table class="table table-condensed">
                        <thead>
                            <tr class="cart_menu" style=" background: #1e90ff;">
                                <td class="image"></td>
                ...
                <!--Form dat hang-->
                    ...
                    <h3>
                        <p style=text-align:center;background-color:#1e90ff;padding:20px;color:white>Tổng Cộng: <?php echo number_format($total) ?> VND</p>
                    </h3>
                    <form id="main-contact-form" class="contact-form row" name="contact-form" method="post" action="thanhtoan.php">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <a class="btn btn-default check_out" href="change.php?control=4" style="background: #ff4757;">Xóa tất cả</a>
                            <input type="submit" name="submitOrder" class="btn btn-primary pull-right" value="Đặt hàng">
