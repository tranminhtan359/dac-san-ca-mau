            ...
            <div class="col-md-12">
                <div class="navbar-header">
                    ...
                    <div class="logo text-center">
                        <a href="index.php">
                            <img src="images/LOGO_1.png" alt="" style="width: 200px; height: 90px" /> <br>
                ...
                <div class="mainmenu pull-right">
                    <ul class="nav navbar-nav collapse navbar-collapse">
                        ...
                        <li><a href="contact.php"><i class="fas fa-phone-volume"></i> Liên hệ</a></li>
                        <li><a href="about.php"><i class="fab fa-blogger-b"></i> Giới thiệu</a>
                        ...
                        <li>
                            ...
                            <?php if (empty($_SESSION['customer_name'])) : ?>
                                ...
                                <a href="./Login/index.php" style="font-size:12px; margin-bottom:-20px">
