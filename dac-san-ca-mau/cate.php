                            ...
                            <form action="" method="GET">
                                <div class="filter_manu">
                                    <div class="card-filter-body">
                                        <h4 style="color:#365d6c;text-align: center;">Lọc sản phẩm</h4>
                                        <hr style="margin-top:-8px;border-top: 3px solid #FE980F;">
                                        <?php
                                        $con = mysqli_connect("localhost", "root", "", "nhomnoname", "3325", 'utf8_general_ci');
                                        ...
                                        ?>
                                            ...
                                            <h5 style="color: #3742fa;width: 36%;border-bottom: 1px double #5352ed;margin-left: 70px;">Loại
                                                sản phẩm</h5> <?php
                                                                ...
                                                                ?>
                                                <div>
                                                    <input style="margin-left: 70px;margin-right: 10px;" type="checkbox" name="protypes[]" value="<?= $proList['type_id']; ?>">
                                                    <?php if (in_array($proList['type_id'], $checked)) {
                                                                        echo "";
                                                                    } ?>
                                                    <?= $proList['type_name']; ?>
                                                </div>
                                    ...
                                    <div class="card-filter-bottom">
                                        <button type="submit" class="btn-filter btn-primary" style="padding: 5px 21px; border-radius: 20px; margin-top: 15px; font-size: 15px;width: 150px;
    margin-left: 40px;">Tìm</button>
                                    </div>
                                                                ...
                                                                <div class="single-products">
                                                                    <div class="productinfo text-center" style="height:360px">
                                                                        <a href="detail.php?id=<?php echo $proditems['ID'] ?>">
                                                                            <img class="img-fluid img-products" src="images/<?php echo $proditems['pro_image'] ?>" alt="" />
                                                                            <p class="title-products "><?php echo $proditems['name'] ?></p>
                                                                            <p class="price-products"><?php echo number_format($proditems['price']) ?>
                                                                                VND
                                                                            </p>
                                                                            <a href="cart.php?id=<?php echo $proditems['ID'] ?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Thêm vào giỏ</a>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
        ...
        ?>
            <h3 style="text-align:center; margin-left: -470px;">
