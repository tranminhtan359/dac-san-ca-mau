  ...
  <div id="user-nav" class="navbar navbar-inverse" style="padding-top:16px">
    ...
    border-left: none">
          ...
          <!-- Đăng xuat admin -->
          <li class=""><a title="" href="../Login/logout.php" style="text-shadow: none;"><i class="icon icon-share-alt" style="color: black;font-size: 15px"></i> <span class="text" style="color: black;font-size: 15px">Đăng xuất</span></a></li>
      </ul>
  </div>